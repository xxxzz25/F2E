...
export default {
  ...
  data() {
    return {
      clickList: ['basic'],
      shipImg: [
        require('@/assets/img-ship-noob@2x.png'),
        require('@/assets/img-ship-beginner@2x.png'),
        require('@/assets/img-ship-developer@2x.png'),
        require('@/assets/img-ship-master@2x.png'),
      ],
      basicData: [
        {
          category: 'basic',
  ...
  computed: {
    nowImg() {
      if (this.isCategory('manager')) {
        this.nowTxt = 3;
        return this.shipImg[3];
      } else if (this.isCategory('js')) {
        this.nowTxt = 2;
        return this.shipImg[2];
      } else if (this.isCategory('css')) {
        this.nowTxt = 1;
        return this.shipImg[1];
      }
      this.nowTxt = 0;
      return this.shipImg[0];
    },
    basicLists() {
  ...
  methods: {
    ...
    addCheck(id, index, subCategory) {
      ...
      const goal = this.basicData.find(item => item.id === id);
