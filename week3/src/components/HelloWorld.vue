    ...
    <div class="content">
      <div class="container">
        <div class="top">
          ...
          <div class="right">
            <span>2018/6/6 <i class="fas fa-caret-right"></i> 2018/6/13</span>
            <select>
        ...
        <div class="product">
          ...
          <div class="right">
            ...
            <div class="item">
              <div class="pic"></div>
              <div class="text">
                <div class="itemName">Cowboy Jacket</div>
                <div class="date">
